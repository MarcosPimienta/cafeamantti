  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-serif text-foreground mb-2">Clientes y Reporte de Ventas</h1>
          <p className="text-foreground/60">Directorio de usuarios y resumen de compras (registrados y manuales).</p>
        </div>
      </div>
              ...
              {!allCustomers || allCustomers.length === 0 ? (
                <tr>
                  <td colSpan={6} className="px-6 py-20 text-center">
                    ...
                    <p className="text-lg font-serif text-foreground">Aún no hay clientes ni ventas</p>
